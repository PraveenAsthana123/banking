...
| Attribute | Value |
|-----------|-------|
| **Use Case ID** | UC-CRED-003 |
| **Department** | Credit Analysis |
| **Status** | Active |
| **Models Deployed** | 3 |
| **Current Accuracy** | 93.7% |

## Description
Predicts probability of loan default within specified time horizons.
...
### Endpoint
```
POST /api/v1/credit-analysis/UC-CRED-003
```
