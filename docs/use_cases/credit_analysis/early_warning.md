...
| Attribute | Value |
|-----------|-------|
| **Use Case ID** | UC-CRED-004 |
| **Department** | Credit Analysis |
| **Status** | Active |
| **Models Deployed** | 2 |
| **Current Accuracy** | 89.8% |

## Description
Identifies early signs of financial distress in borrowers before default occurs.
...
### Endpoint
```
POST /api/v1/credit-analysis/UC-CRED-004
```
