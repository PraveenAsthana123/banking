# SME Lending Analysis

## Overview
| Attribute | Value |
|-----------|-------|
| **Use Case ID** | UC-CRED-009 |
...
## Description
Assesses creditworthiness of small and medium enterprises for lending decisions.
...
### Endpoint
```
POST /api/v1/credit-analysis/UC-CRED-009
```
