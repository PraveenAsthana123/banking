...
| Attribute | Value |
|-----------|-------|
| **Use Case ID** | UC-RISK-007 |
| **Department** | Risk Management |
| **Status** | Active |
| **Models Deployed** | 2 |
| **Current Accuracy** | 92.1% |

## Description
Models sensitivity of portfolio values to changes in interest rates.
...
### Endpoint
```
POST /api/v1/risk-management/UC-RISK-007
```
